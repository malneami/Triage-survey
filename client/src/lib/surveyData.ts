...
export const PART_A_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "a12",
        en: "Think of your MOST difficult triage case recently — what made it difficult? (Choose the TOP 2)",
        ar: "فكر في أصعب حالة فرز واجهتها مؤخراً — ما الذي جعلها صعبة؟ (اختر أهم اثنتين)",
        type: "checkbox",
        maxSelect: 2,
        options: [
          { value: "atypical",   en: "Atypical presentation",                 ar: "أعراض غير نمطية",              emoji: "🧩" },
          { value: "borderline", en: "Borderline between two CTAS levels",    ar: "حالة بين مستويين من CTAS",     emoji: "⚖️" },
          { value: "peds",       en: "Pediatric age/weight factors",          ar: "عوامل العمر أو الوزن للأطفال", emoji: "🧒" },
          { value: "language",   en: "Language/communication barrier",        ar: "حاجز اللغة أو التواصل",        emoji: "🗣️" },
          { value: "workload",   en: "Workload and interruptions",            ar: "ضغط العمل والمقاطعات",         emoji: "🌀" },
          { value: "incomplete", en: "Incomplete vitals or information",      ar: "علامات حيوية أو معلومات ناقصة", emoji: "📉" },
          { value: "family",     en: "Family pressure",                       ar: "ضغط من الأسرة",                emoji: "👪" },
          { value: "none",       en: "I haven't had a difficult case",        ar: "لم أواجه حالة صعبة",           emoji: "✅" },
        ],
      },
      {
        id: "a13",
        en: "Briefly describe that case, or share anything else about triage challenges — no names or file numbers. (Optional)",
        ar: "صف تلك الحالة باختصار، أو شارك أي شيء آخر عن تحديات الفرز — بدون أسماء أو أرقام ملفات. (اختياري)",
        type: "textarea",
      },
    ],
  },
...
export const PART_B_SECTIONS: Section[] = [
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          { value: "workup",     en: "Repeated workup / duplicated tests",              ar: "إعادة فحوصات أو تكرار تحاليل",       emoji: "🔁" },
          { value: "bed",        en: "Bed misallocation",                               ar: "سوء توزيع الأسرّة",                  emoji: "🛏️" },
          { value: "los",        en: "Prolonged ED length of stay",                     ar: "إطالة مدة البقاء في الطوارئ",        emoji: "🕰️" },
          { value: "staff",      en: "Staff pulled away from other patients",           ar: "سحب الكادر من مرضى آخرين",           emoji: "🧑‍⚕️" },
          { value: "dxdelay",    en: "Delayed diagnosis or treatment",                  ar: "تأخر التشخيص أو العلاج",             emoji: "⏳" },
          { value: "escalation", en: "Unplanned escalation (resus / rapid response)",   ar: "تصعيد غير مخطط (إنعاش / استجابة سريعة)", emoji: "🚨" },
          { value: "complaint",  en: "Patient/family dissatisfaction or complaint",     ar: "استياء أو شكوى المريض أو الأسرة",    emoji: "📣" },
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "b7",
        en: "When mismatches happen, they are mostly:",
        ar: "عندما تحدث حالات عدم التوافق، فهي غالباً:",
        type: "radio",
        options: [
          { value: "under", en: "Under-triaged — patient was sicker than the level suggested",  ar: "فرز أقل من اللازم — المريض أكثر خطورة مما يوحي المستوى", emoji: "🔻" },
          { value: "over",  en: "Over-triaged — patient was less sick",                         ar: "فرز أعلى من اللازم — المريض أقل خطورة",                   emoji: "🔺" },
          { value: "both",  en: "Both directions equally",                                      ar: "في الاتجاهين بالتساوي",                                    emoji: "↕️" },
          { value: "na",    en: "Not applicable — I haven't seen a mismatch",                   ar: "لا ينطبق — لم أرَ عدم توافق",                              emoji: "✅" },
        ],
      },
      {
        id: "b8",
      ...
      {
        id: "b10",
        en: "Briefly describe a specific mismatch case, or anything else you'd like to share — no names or file numbers. (Optional)",
        ar: "صف حالة عدم توافق محددة باختصار، أو شارك أي شيء آخر — بدون أسماء أو أرقام ملفات. (اختياري)",
        type: "textarea",
      },
    ],
  },
